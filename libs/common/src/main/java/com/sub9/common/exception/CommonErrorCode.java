...
public enum CommonErrorCode implements ErrorCode {
  ...
  UNSUPPORTED_MEDIA_TYPE(
      "COMMON_0006", HttpStatus.UNSUPPORTED_MEDIA_TYPE, "지원하지 않는 Content-Type입니다."),
  UNAUTHORIZED("COMMON_0007", HttpStatus.UNAUTHORIZED, "인증이 필요합니다."),
  FORBIDDEN("COMMON_0008", HttpStatus.FORBIDDEN, "접근 권한이 없습니다."),
  SERVICE_UNAVAILABLE("COMMON_0009", HttpStatus.SERVICE_UNAVAILABLE, "서비스에 일시적으로 접근할 수 없습니다.");
