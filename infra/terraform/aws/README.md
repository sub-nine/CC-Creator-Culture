...
스택은 bootstrap, persistent, runtime 세 개다. runtime 은 `release_sha`, `config_sha`, `app_running` 세 변수로 태스크 정의, desired_count, RDS와 관측 EC2 전원을 소유한다. 자세한 것은 각 디렉터리 README 에 있다.
