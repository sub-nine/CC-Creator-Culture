...
public class UserCoupon extends CouponBaseEntity {
    ...
    private UserCoupon(UUID id, UUID couponId, UUID userId, Instant issuedAt) {
        super(id, userId, issuedAt);
        this.couponId = Objects.requireNonNull(couponId, "쿠폰 식별자는 필수입니다.");
    ...
    public static UserCoupon issue(UUID id, UUID couponId, UUID userId, Instant issuedAt) {
        return new UserCoupon(id, couponId, userId, issuedAt);
    }
