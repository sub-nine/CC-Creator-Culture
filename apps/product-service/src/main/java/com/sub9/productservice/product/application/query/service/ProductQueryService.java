...
public class ProductQueryService {
  ...
  public ProductDetailResponse getProductDetail(UUID productId, UUID visitorId) {
    // TODO : 현재 정지 상태인 상품을 모두 조회를 할 수 있는 문제가 있어 추후 수정예정
    ProductDetailResponse response =  productQueryRepository
  ...
  public List<SkuResponse> getSkus(List<UUID> skuIds) {
    if (skuIds.isEmpty()) {
      return List.of();
    }
