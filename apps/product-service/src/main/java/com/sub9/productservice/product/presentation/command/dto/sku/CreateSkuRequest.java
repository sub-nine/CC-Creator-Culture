package com.sub9.productservice.product.presentation.command.dto.sku;
...
public record CreateSkuRequest(
    ...
    boolean isDefault,
    @PositiveOrZero(message = "재고는 0개 이상이어야 합니다.") int quantity) {
  public CreateSkuCommand toCommand() {
    return new CreateSkuCommand(name, price, isDefault, quantity);
  }

  public AddSkuCommand toCommand(UUID productId, UUID creatorId) {
    return new AddSkuCommand(productId, creatorId, name, price, isDefault, quantity);
  }
}
